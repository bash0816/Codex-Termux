...
must(manifest.canonical_package_status === 'ready_to_publish', 'manifest package status drift');
must(manifest.support_status === 'publish_ready_not_yet_public_supported', 'manifest support status drift');
...
must(rootReadme.includes('Public publish gate is ready.'), 'root README missing publish-ready wording');
...
must(guidance.includes('public publish gate is ready'), 'guidance missing publish-ready wording');
